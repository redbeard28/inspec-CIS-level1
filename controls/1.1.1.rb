...
cis_level = attribute('cis_level', value: '1')

title '1.1 Filesystem Configuration'

control 'cis-benchmark-1.1.1.1' do
...
control 'cis-benchmark-1.1.1.2' do
...
control 'cis-benchmark-1.1.1.3' do
...
control 'cis-benchmark-1.1.1.4' do
...
control 'cis-benchmark-1.1.1.5' do
...
control 'cis-benchmark-1.1.1.6' do
...
control 'cis-benchmark-1.1.1.7' do
...
control 'cis-benchmark-1.1.1.8' do
...
control 'cis-benchmark-1.1.2' do
...
control 'cis-benchmark-1.1.3' do
...
control 'cis-benchmark-1.1.4' do
...
control 'cis-benchmark-1.1.5' do
...
control 'cis-benchmark-1.1.6' do
...
control 'cis-benchmark-1.1.7' do
...
control 'cis-benchmark-1.1.8' do
...
control 'cis-benchmark-1.1.9' do
...
control 'cis-benchmark-1.1.10' do
...
control 'cis-benchmark-1.1.11' do
...
control 'cis-benchmark-1.1.12' do
...
control 'cis-benchmark-1.1.13' do
...
control 'cis-benchmark-1.1.14' do
...
control 'cis-benchmark-1.1.15' do
...
control 'cis-benchmark-1.1.16' do
...
control 'cis-benchmark-1.1.17' do
...
control 'cis-benchmark-1.1.18' do
  ...
  describe 'cis-benchmark-1.1.18' do
    skip 'Not implemented'
  end
end

control 'cis-benchmark-1.1.19' do
  ...
  describe 'cis-benchmark-1.1.19' do
    skip 'Not implemented'
  end
end
